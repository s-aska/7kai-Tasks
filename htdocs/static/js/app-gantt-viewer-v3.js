...
app.data.gantt_listli_map = {};
app.data.gantt_taskli_map = {};
app.setup.ganttchartListsV3 = function(ul){
    var listli_map = app.data.gantt_listli_map;
    ...
    //     var lis = app.data.gantt_listli_map[list.id].find('> ul > li');
...
// app.setup.ganttchartTasksV3 = function(ul){
//     if (!ul.parent().data('id')) {
//         return;
//     }
//     
// 
